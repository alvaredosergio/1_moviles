...
public class SticksGame {
		...
		System.out.println("Bienvenido al juego de los Palos Tachados. Debes tachar de 1 a 4 palos en tu turno.");
		System.out.println("El que tache en último lugar, pierde. BUENA SUERTE!!\n");
		pintar(sticks, crossed);

		while (crossed < 21) {
			System.out.println("");
			System.out.println("Debes tachar de 1 a 4 palos. ¿Cuantos palos deseas tachar?");
			decision = sc.nextInt();
