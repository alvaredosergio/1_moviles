...
public class JuegoDados extends AppCompatActivity {
    // Botones
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegodados);
        ...
        // OnClickListeners
        generar.setOnClickListener(view ->{pintar(d1,d2,d3,d4);sumar(dice1,dice2,dice3,dice4);});
